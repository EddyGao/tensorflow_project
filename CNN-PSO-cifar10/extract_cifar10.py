...
class Cifar10DataSet(object):
	...
	def __init__(self,data_dir):
		...
		self.train_labels,self.train_images = extract_train_data(os.path.join(data_dir,'new_cifar10/cifar-10-batches-bin'))
		self.test_labels,self.test_images = extract_test_data(os.path.join(data_dir,'new_cifar10/cifar-10-batches-bin'))
	...
	def next_train_batch(self,batch_size):
		...
		#print np.shape(self.train_images[start:end])
		#print type(self.train_images[start:end])

		#print np.shape(self.train_labels[start:end])
